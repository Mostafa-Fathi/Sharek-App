...
//    }
    ...
    public void onClick(View v) {
        if (v == post) {
           ...
           if (description.getText().toString().length()>14){
...
//                    jsonObject.getJSONObject("availability").getJSONObject("days").put("fri",fri.isChecked());
                    ...
                    final JsonObjectRequest req = new JsonObjectRequest(URL, jsonObject,
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(AddIntrest.this, "Enter Valid data, follow instructions", Toast.LENGTH_LONG).show();
               ...
               loading.dismiss();
               Toast.makeText(AddIntrest.this, "Please write the description with enough data", Toast.LENGTH_SHORT).show();
               }
            } else {
                loading.dismiss();
