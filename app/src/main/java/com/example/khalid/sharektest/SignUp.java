...
public class SignUp extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View v) {
        if (v == getlocation) {
           ...
           String s = "[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+\\.?+[a-z]+\\.?+[a-z]";
            if (uname.getText().toString().length() > 5) {
                if (email.getText().toString().matches(s)) {
                    if (haddress.getText().toString().length() > 10) {
                        if (photo == null) {
                            if (pass.getText().toString().length() > 7) {
                                if (pass.getText().toString().equals(repass.getText().toString())) {
                                    if (phone.getText().toString().length() > 10 & phone.getText().toString().matches("01[0-2][0-9]+")) {
                                        if (getLocationBtnClicked) {


                                            String params_Date =
                                                    ("{"
                                                            + " \"user\":" + "\"" + uname.getText().toString().toLowerCase() + "\"" + ","
...
//                                    intent.putExtra("token", token);
                                                            ...
                                                            mypreference.edit().putString("myUserName", uname.getText().toString().toLowerCase()).apply();
...
//                            return headers;
                                        ...
                                        Toast.makeText(this, "Write your phone correctly", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                    ...
                    Toast.makeText(SignUp.this, "Please Write Email correctly", Toast.LENGTH_LONG).show();
                }
            } else {
