...
//        }, 300, 300, null, null);
        ...
        Ppic.setErrorImageResId(R.drawable.blank_photo);
        ...
        JsonObjectRequest req = new JsonObjectRequest(url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                pDialog.dismiss();
                Toast.makeText(ProductPage.this, "you cannot connect to the internet", Toast.LENGTH_LONG).show();
//                pDialog.hide();
            }
        }) {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                */// we need to get image of owner name
                                ...
                                /*final TextView ownerMail = (TextView) yourCustomView.findViewById(R.id.ownerInfoDialog_mail);
                                ownerMail.setText(response.get("email").toString());
                                */
